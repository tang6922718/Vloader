...
public class KafkaUtils {
    ...
    static {
        ...
        props.put("bootstrap.servers", "192.168.1.21:9092");//服务器ip:端口号，集群用逗号分隔
        props.put("acks", "all");
        props.put("retries", 0);
    ...
    static {
        ...
        consumer.subscribe(Arrays.asList("travel1"),new ConsumerRebalanceListener() {
        ...
        while(true){
            ...
            if (records.count() > 0) {
                for (ConsumerRecord<String, String> record : records) {
                    LOGGER.info("--"+(++num) +" 从kafka接收到的消息是：" +record.value());
                }
            }
        }
    }
